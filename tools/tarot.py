...
def register(mcp: FastMCP) -> None:
    ...
    @mcp.tool(
        ...
        description=(
            ...
            "The visual description field (imagery of the card) is a differentiator not present "
            "in most tarot APIs. Use this endpoint to populate card databases, build card browsers, "
