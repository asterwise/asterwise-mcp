...
def register(mcp: FastMCP) -> None:
    ...
    @mcp.tool(
        ...
        description=(
            ...
            "dignities per Ptolemy/Lilly/Hand, all active aspects using Robert Hand Table 2 orbs, "
            "and element/modality/hemisphere balance statistics.\n\n"
            ...
            "(Lilly weights: domicile +5, exaltation +4, triplicity +3, term +2, face +1, "
            ...
            "modern astrologers). Aspects use Hand Table 2 orbs: conjunction/opposition 5°, "
            "square/trine 5°, sextile 3°, minor aspects 1.5°. Accuracy verified against astro-seek.com "
            "to within 0.01° for all 10 planets. Not Vedic sidereal (asterwise_get_natal_chart).\n\n"
            "SECTION: WORKFLOW\n"
    ...
    @mcp.tool(
        ...
        description=(
            ...
            "every aspect within the Hand Table 2 orbs.\n\n"
            "SECTION: WHAT THIS TOOL COVERS\n"
            "Flexible aspect calculator that works with any set of positions — natal planets, "
            "transit planets, progressed planets, or custom hypothetical points. Uses Robert "
            "Hand Table 2 orbs: conjunction/opposition 5°, square/trine 5°, sextile 3°, "
    ...
    @mcp.tool(
        ...
        description=(
            ...
            "(Hand Planets in Transit): major 3°, sextile 2°, minor 1°. Provide start_date for "
            ...
            "Edge cases:\n"
            "  Transit orbs use Hand Planets in Transit table (smaller than natal orbs): "
    ...
    @mcp.tool(
        ...
        description=(
            ...
            "aspects using Robert Hand Table 2 orbs. Useful for relationship compatibility analysis.\n\n"
            "SECTION: WHAT THIS TOOL COVERS\n"
            ...
            "asterwise_get_western_compatibility — proprietary 0–100 score vs raw aspects."
        ),
        annotations=mcp_types.ToolAnnotations(
            readOnlyHint=True, destructiveHint=False,
            idempotentHint=True, openWorldHint=True,
    ...
    @mcp.tool(
        ...
        description=(
            "Midpoint composite chart for two people (Robert Hand method). Each composite planet is "
    ...
    @mcp.tool(
        ...
        description=(
            ...
            "sign comparisons.\n\n"
            "SECTION: WHAT THIS TOOL COVERS\n"
            "Weighted proprietary scoring model combining elemental harmony, personal-planet synastry "
            ...
            "INTERNAL_ERROR: Any upstream API failure or timeout → MCP INTERNAL_ERROR\n"
            "Edge cases:\n"
            "  Score is our proprietary model — not universal. Use for relative comparison, "
    ...
    @mcp.tool(
        ...
        description=(
            ...
            "Returns all 10 progressed planet positions, progressed Ascendant and MC (True Quotidian "
            "method), and the solar arc.\n\n"
            "SECTION: WHAT THIS TOOL COVERS\n"
            "Naibod-style secondary directions: Moon advances ~12°/year of life, Mercury/Venus track "
            ...
            "INTERNAL_ERROR: Any upstream API failure or timeout → MCP INTERNAL_ERROR\n"
            "Edge cases:\n"
            "  Progressed ASC uses True Quotidian method (actual house calculation at progressed JD) "
            "not Solar Arc approximation — this is the more accurate approach. Progressed MC uses Solar Arc "
            "approximation (natal MC + solar arc) which is standard.\n\n"
            "SECTION: DO NOT CONFUSE WITH\n"
    ...
    @mcp.tool(
        ...
        description=(
            ...
            "SECTION: WHAT THIS TOOL COVERS\n"
            "Naibod arc or solar arc directions — one delta longitude applied to every natal body and "
